...
class SateUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.commandline.add_option('checkpoint', StringUserSetting(name='checkpoint', default=None, short_name='c', help='If used, then program will be checkpionted at certain points. The state of the program will be saved in the file given by "CHECKPOINT". If the given file is found, the previous run is resumed from the saved state.', subcategory=None))  
        ...
        self.sate.add_option('max_mem_mb', IntUserSetting(name='max_mem_mb', default=2048, min=1024, max="x", short_name=None, help='The maximum memory available (for the Java heap size when running Java tools)', subcategory='platform'))
