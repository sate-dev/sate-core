...
class SateUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.commandline.add_option('checkpoint', BoolUserSetting(name='checkpoint', default='False', short_name='c', help='If used, then program will be checkpionted at certain points. The checkpoints will be saved under "checkpoint" directory in the output directory. If "checkpoint" directory is found, the previous run is resumed from the checkpointed point.', subcategory=None))        
