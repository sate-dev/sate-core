...
class SateUserSettings(UserSettingsContainer):
    def __init__(self):
        ...
        self.cobalt = UserSettingGroup('cobalt')
        self._categories.append('cobalt')
        ...
        self.cobalt.add_option('path', StringUserSetting(name='path', default='', short_name=None, help='Path to Cobalt executable', subcategory=None))
        self.cobalt.add_option('db_path', StringUserSetting(name='db_path', default='', short_name=None, help='Path to Cobalt database', subcategory=None))
